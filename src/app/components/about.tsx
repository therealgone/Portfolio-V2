...
export default function About({ active }: navprop) {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen py-20 px-4 text-zinc-300">
      {show && (
        <div className="w-full max-w-6xl">
          <motion.div className="text-center mb-16" {...motionProps90}>
            <motion.h1
              className="text-5xl md:text-7xl font-bold text-white bg-clip-text mb-10 text-center"
              {...motionProps90}
            >
              About Me
            </motion.h1>
          ...
          <motion.div className="p-px animate-rotate-border rounded-3xl bg-conic/[from_var(--border-angle)] from-white via-zinc-800 to-zinc-900"
            {...motionProps90}>
            <div className="py-5 px-6 backdrop-blur-3xl rounded-3xl bg-zinc-950">
              <motion.div className="text-center mb-12" {...motionProps90}>
                ...
                <motion.p className="text-lg md:text-xl text-zinc-400 font-medium" {...motionProps90}>
                  Computer Science Engineering (AI & ML)
                </motion.p>
                <motion.p className="text-base text-zinc-500 mt-2" {...motionProps90}>
              ...
              <motion.div className="mt-12 pt-8 border-t border-zinc-700/20" {...motionProps90}>
                <div className="text-center">
                  <motion.div
                    className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-zinc-700/10 to-zinc-900/10 rounded-full border border-zinc-600/30"
                  ...
                  >
                    <span className="text-zinc-400 font-medium">Always Learning • Always Building • Always Growing</span>
                  </motion.div>
                </div>
              </motion.div>
            </div>
