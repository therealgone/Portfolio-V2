    ...
    <div className="flex flex-col items-center min-h-screen py-20 px-4">
      {show && (
        <div className="w-full max-w-6xl">
          ...
          {/* Main Content Card */}
          <motion.div
            className="gpu-boost animate-rotate-border rounded-3xl p-px bg-conic/[from_var(--border-angle)] from-black via-cyan-400 to-black shadow-2xl"
            {...motionProps90}
          >
            <div className="bg-[#0f172a]/90 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-cyan-500/20">
              {/* Profile Header */}
              <motion.div
