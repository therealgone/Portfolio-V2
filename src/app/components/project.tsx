...
export default function projects({ active }: nav) {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center space-y-6 md:space-y-8 lg:space-y-12 px-4 md:px-8 lg:px-16 py-10 md:py-0">
            <motion.h1
                initial={{ opacity: 0, y: -20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.5 }}
                className="text-3xl md:text-4xl lg:text-7xl font-bold text-white mb-6 md:mb-10 text-center"
            >
                Projects
            </motion.h1>

            <div className="w-full max-w-7xl mx-auto space-y-6 md:space-y-8 lg:space-y-12">
                ...
                >
                    <div className="relative w-full aspect-[9/7] rounded-xl md:rounded-2xl lg:rounded-3xl overflow-hidden shadow-2xl hover:scale-[1.02] transition-transform duration-300 cursor-pointer hover:shadow-white/10">
                        <img
                        ...
                        />
                        <div className="absolute bottom-0 w-full h-[120px] md:h-[150px] lg:h-[200px] bg-gradient-to-br from-gray-800/10 to-gray-900/10 backdrop-blur-xl border-t border-gray-700/10 p-3 md:p-4 lg:p-5">
                            <h1 className="text-white text-base md:text-lg lg:text-xl">Fake News Detection Project</h1>
                            <p className="text-white/70 mt-1 md:mt-2 text-xs md:text-base lg:text-xl">
